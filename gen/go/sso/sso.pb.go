...
type RegisterRequest struct {
	...
	Username      string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // Login of the user to register.
...
type LoginRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Username      string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`         // Login of the user to login.
	Email         string                 `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`               // Email of the user to alternative login.
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB\x16Z\x14iProtas.sso.v1;ssov1b\x06proto3"
